    ...
    protected function configure()
    {
        $this
            ...
            ->setDefinition([
                ...
                new InputOption('renderpath', null, InputOption::VALUE_OPTIONAL, 'Build specific pages filtered by path'),
...
EOF
    ...
    protected function execute(InputInterface $input, OutputInterface $output)
    {
        ...
        if ($input->getOption('renderpath')) {
            $options['renderPath'] = (string) $input->getOption('renderpath');
        }
