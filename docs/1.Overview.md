...
PHPoole is a [CLI](https://en.wikipedia.org/wiki/Command-line_interface) application that merge plain text files, images and templates to build a [static website](https://en.wikipedia.org/wiki/Static_web_page).
