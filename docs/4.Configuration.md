...
The local website configuration file (`config.yml`) overrides the [default configuration](https://github.com/Cecilapp/Cecil/blob/master/config/default.php#L11) (`default.php`).
...
- `assets`: Assets cache
  - `dir`: a subdirectory of remote assets cache
