...
> See [_Configuration_](4.Configuration.md#pagination).
...
The filename can contain a _prefix_ to define _Page_'s `date` or `weight` (sort order).
...
If the page's language is different from the site language (see `language` in [*Configuration*](4.Configuration.md#language)) you must specify it.
