...
If some pages have content localized / translated in a different language from the main one (see [*Configuration*](4.Configuration.md#language)) there is 2 ways to define it:
