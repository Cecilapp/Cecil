...
To be able to use variables and shortcodes you must include a specific template instead of the `{{ page.content }}`:
...
A shortcode is a [Twig macro](https://twig.symfony.com/doc/tags/macro.html) you should write in the `shortcodes.twig` template.
