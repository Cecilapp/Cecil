...
> 3. Files in `static/` are copied as is in the root of the built website (ie: `static/images/logo.png` -> `images/logo.png`) or manipulated by [`asset()`](3.Templates.md#asset)
