...
Content directory is a bunch of [Markdown](https://daringfireball.net/projects/markdown/) files (or plain text files), called [**_Pages_**](#pages), organized in folders.
