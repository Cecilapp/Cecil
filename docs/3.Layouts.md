...
A layout is a [Twig](http://twig.sensiolabs.org) template, so refer to the [official documentation](https://twig.symfony.com/doc/2.x/templates.html) to know how to use it.
...
| `cecil.poweredby` | "Cecil/PHPoole v%s" with "%s" = current version |
