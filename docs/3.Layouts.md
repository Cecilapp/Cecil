...
A PHPoole's layout is a [Twig](http://twig.sensiolabs.org) template, so refer to the [official documentation](https://twig.symfony.com/doc/2.x/templates.html) to know how to use it.
...
Otherwise:
 1. `<section>/page.html.twig`
 2. `$section/<layout>.html.twig`
 3. `<layout>.html.twig`
 4. `page.html.twig`
...
| `page.pages`      | Pages under `page`                 | _Collection_  |
...
| `phpoole.poweredby` | "PHPoole (library v<current version>)" |
