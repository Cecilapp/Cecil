...
Cecil support text translation and date localization through [Twig Extensions]([https://twig-extensions.readthedocs.io](https://twig-extensions.readthedocs.io/)):
...
This extension use [*Gettext*](https://wikipedia.org/wiki/GNU_gettext), so translation files (`.mo`) must be stored in the right directory of your project, like that:
