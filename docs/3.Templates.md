...
Cecil comes with a set of [default templates](https://github.com/Cecilapp/Cecil/tree/master/res/layouts).
...
This extension use [*Gettext*](https://www.php.net/gettext), so translation files (`.mo`) must be stored in the right directory of your project, like that:
